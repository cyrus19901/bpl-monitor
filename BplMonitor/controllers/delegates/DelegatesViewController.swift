...
class DelegatesViewController: UIViewController {
    ...
    func loadDelegates() -> Void {
        ...
        BplService.sharedInstance.requestActiveDelegates(settings: settings, listener: requestActiveDelegates)
        
        BplService.sharedInstance.requestStandyByDelegates(settings: settings, listener: requestStandbyDelegates)
    }
    ...
    private class RequestActiveDelegates: RequestListener {
        ...
        func onResponse(object: Any)  -> Void {
            ...
            if (selfReference.delegates.count > 201) {
                NVActivityIndicatorPresenter.sharedInstance.stopAnimating()
